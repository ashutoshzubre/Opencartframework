...
import org.testng.asserts.SoftAssert; // Ensure this import is present
...
public class TC006_EndToEndTest extends BaseClass {
    ...
    public void endToendTest() throws InterruptedException
    {
        ...
        // Action steps causing the red underlines
        ch.clickContinueAfterBillingAddress();
        Thread.sleep(1000);
        ch.clickContinueAfterDeliveryAddress();
        Thread.sleep(1000);
        ch.setDeliveryMethodComment("testing...");
        Thread.sleep(1000);
        ch.clickContinueAfterDeliveryMethod();
        Thread.sleep(1000);
        ch.selectTermsAndConditions();
        Thread.sleep(1000);
        ch.clickContinueAfterPaymentMethod();
        Thread.sleep(2000);
        
        String total_price_inOrderPage = ch.getTotalPriceBeforeConOrder();
